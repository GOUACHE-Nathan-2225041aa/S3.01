...
class Young
{
    public function execute(): void
    {
        if($_SESSION['picturesDone'] >= 3){
            ...
            $D1 = new DeepfakeModel('Trump qui court...', 'https://ichef.bbci.co.uk/news/640/cpsprodpb/582D/production/_129137522_faketrump1.png', false, "Si tu regarde bien à gauche de l'image, on voit un bandeau rouge avec écrit FAKE... à par ça l'image est bien faite","Explication 1 :");
            $D2 = new DeepfakeModel('Image numéro 2 (faux)', 'https://www.virginiebonnet.com/wp-content/plugins/widgetkit/cache/gallery/528/image2-dc3d866a26.jpg', false, "indice 2","Explication 2 :");
            $D3 = new DeepfakeModel('Image numéro 3 (vrai)', 'https://soreca-bordeaux.com/images/yootheme/widgetkit/gallery/image3.jpg', true, "indice 3","Explication 3 :");
